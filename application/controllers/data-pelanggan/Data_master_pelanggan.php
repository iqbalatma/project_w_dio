...
class Data_master_pelanggan extends CI_Controller
{
    ...
    public function ini_untuk_tambah_pegawai_bodohhhh()
    {
      // set form rules
      ...
      $this->form_validation->set_rules('add-first-name', 'nama depan', 			'required|trim|min_length[3]|max_length[100]');
      $this->form_validation->set_rules('add-last-name', 'nama belakang', 		'trim|min_length[3]|max_length[100]');
      $this->form_validation->set_rules('add-phone', 'no telepon', 						'required|trim|is_numeric|min_length[10]|max_length[14]');
      $this->form_validation->set_rules('add-address', 'alamat lengkap',      'required|trim|min_length[5]|max_length[250]');
      ...
      if ($this->form_validation->run() == FALSE) {
        ...
        $query = $this->customer_m->set_update_meta_by_id(1, $post);
