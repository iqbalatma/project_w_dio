...
class Data_invoice extends CI_Controller
{
    ...
    public function index()
    {
        ...
        {
            $invoices = $this->invoice_m->get_all_with_trx('i.id, i.invoice_number, t.deliv_address, t.price_total, i.paid_amount, i.left_to_paid, i.created_at, i.payment_img', $this->session->store_id);
        }
        else {
            $invoices = $this->invoice_m->get_all_with_trx('i.id, i.invoice_number, t.deliv_address, t.price_total, i.paid_amount, i.left_to_paid, i.created_at, i.payment_img');
        }
